...
- [x] M1: N-API bridge → **35 native methods, 32 public NativeBridge methods** (dead surface removed in codex batch, Task #106; 7 more native methods pruned in E1)
