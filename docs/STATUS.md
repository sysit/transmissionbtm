...
- **Non-blocking async completion primitive for slow ops** (add-from-file / relocate, so the UI thread isn't blocked) — future item. (The remove half of the original P0 "async session-thread dispatch" is FIXED 2026-08-23.)
